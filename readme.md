...
- Also, you'd better implement your own version of "verifyState" function. It can check if other storage variables are in the same slots. See [test/contracts/Target.sol](test/contracts/Target.sol) for example